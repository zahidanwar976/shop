...
const SOFTWARE_VERSION = '14.0';

const THEME_RATIO = [
    'default' => [
        'Main Banner'=>'Ratio 4:1',
        'Footer Banner'=>'Ratio 4:1',
        'Popup Banner'=>'Ratio 4:1',
        'Main Section Banner'=>'Ratio 4:1',
    ],
    'theme_aster' => [
        'Main Banner'=>'Ratio 2:1',
        'Footer Banner'=>'Ratio 4:1',
        'Popup Banner'=>'Ratio 2:1',
        'Header Banner'=>'585x160 px',
        'Sidebar Banner'=>'280x500 px',
        'Top Side Banner'=>'205x500 px',
        'Main Section Banner'=>'Ratio 4:1',
    ],
];
