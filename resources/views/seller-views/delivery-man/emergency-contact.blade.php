    ...
    <div class="content container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <form action="{{route('seller.delivery-man.emergency-contact.add')}}" method="post">
                    @csrf
                    <div class="card">
                        <!-- End Page Header -->
                        <div class="card-body">
                            ...
                            @forelse($contacts as $contact)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{route('seller.delivery-man.emergency-contact.destroy')}}"
            ...
            Swal.fire({
                ...
                reverseButtons: true
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            url: "{{ route('seller.delivery-man.emergency-contact.ajax-status-change') }}",
                            method: 'POST',
                            data: {
                                status: status,
                                id : id
