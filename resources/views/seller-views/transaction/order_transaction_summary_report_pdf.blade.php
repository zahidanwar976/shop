                ...
                <tr>
                    <td class="p-0 text-left">
                        <table>
                            <tr>
                                ...
                                <td class="p-0" style="padding: 3px 0">: {{ $duration }}</td>
                            </tr>
                            <tr>
                    ...
                    <td class="p-0 text-left">
                        <table>
                            ...
                            <tr>
                                <th class="bold black p-0 text-left">{{\App\CPU\translate('Completed_Orders')}}</th>
                                <td class="p-0" style="padding: 3px 0;">:
                                    {{ $data['completed_order'] }}
                                </td>
                            </tr>
                            <tr>
                                <th class="bold black p-0 text-left">{{\App\CPU\translate('Ongoing_Orders')}}</th>
                                <td class="p-0" style="padding: 3px 0;">:
                                    {{ $data['ongoing_order'] }}
                                </td>
                            </tr>
                            <tr>
                                <th class="bold black p-0 text-left">{{\App\CPU\translate('Canceled_Orders')}}</th>
                                <td class="p-0" style="padding: 3px 0;">:
                                    {{ $data['canceled_order'] }}
                                </td>
                            </tr>
