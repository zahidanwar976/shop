    ...
    <tr>
        <td class="pt-0">
            <table class="bs-0">
                <tr>
                    <td class="p-0 text-left">
                        <span class="bold black p-0 text-left">{{\App\CPU\translate('duration')}}</span> :
                        <span class="p-0" style="padding: 3px 0;text-transform:capitalize">{{ $data['duration'] }}</span>
                        <br><br>
                        <span class="bold black p-0 text-left">{{\App\CPU\translate('seller')}} {{\App\CPU\translate('info')}}</span> :
                        <span class="p-0" style="padding: 3px 0;text-transform:capitalize">{{ $data['shop_name'] }}</span>
                    </td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
            ...
            <table class="bs-0 __product-table inter">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{\App\CPU\translate('Total_Expense_Amount')}}</td>
                        <td class="text-right">
                    ...
                    <tr>
                        ...
                        <td>{{\App\CPU\translate('Free_Delivery_Amount')}}</td>
                    ...
                    <tr>
                        ...
                        <td>{{\App\CPU\translate('Coupon_Discount_Amount')}}</td>
                        <td class="text-right" style="padding: 3px 0;">
...
<table class="">
    <tr>
        <th class="content-position-y bg-light py-4 footer">
            ...
            <div>
                {{\App\CPU\translate('All_copy_right_reserved_©_'.date('Y').'_').$data['company_name']}}
            </div>
        </th>
    </tr>
</table>
