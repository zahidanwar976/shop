                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="card h-100 d-flex justify-content-center align-items-center">
                            <div class="card-body d-flex flex-column gap-10 align-items-center justify-content-center">
                                <img width="48" src="{{asset('/public/assets/back-end/img/cc.png')}}" alt="">
                            ...
                            <a href="{{ route('admin.delivery-man.collect-cash', ['id' => $delivery_man->id]) }}" class="btn btn--primary mb-4">{{\App\CPU\translate('Collect_Cash')}}</a>
                        </div>
                        <!-- End Card -->
                    </div>
                    <div class="col-lg-8">
                            ...
                            <div class="col-md-6">
                                <div class="card card-body h-100 justify-content-center py-5">
                                    <div class="d-flex gap-2 justify-content-between align-items-center">
                                        ...
                                        <div>
                                            <img width="40" src="{{asset('/public/assets/back-end/img/withdraw-icon.png')}}" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="card card-body h-100 justify-content-center py-5">
                                    <div class="d-flex gap-2 justify-content-between align-items-center">
                                        ...
                                        <div>
                                            <img width="40" class="mb-2" src="{{asset('/public/assets/back-end/img/withdraw.png')}}" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-md-6 mt-3">
                <div class="card">
                    ...
                    <div class="card-body"
                        ...
                        <div class="flex-start">
                            <div><h5 class="text-nowrap">{{\App\CPU\translate('Email')}} : </h5></div>
                            <div class="mx-1"><h5>{{$delivery_man->email}}</h5></div>
                        </div>
                        <div class="flex-start">
                            <div><h5 class="text-nowrap">{{\App\CPU\translate('Phone')}} : </h5></div>
